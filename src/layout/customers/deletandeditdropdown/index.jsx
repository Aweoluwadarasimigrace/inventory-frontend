...
import EditCustomerButton from '../editcustomerrform/editcustomerButton'

const DeleteAndEditDropdown = ({ customerId }) => {
            ...
            <div className="relative text-left block">
                ...
                >
                    <div className="flex flex-col">
                        ...
                        <button className="w-full text-left px-4 py-2 hover:bg-purple-100 hover:text-purple-700 flex items-center gap-2" onClick={() => removeCustomer(customerId)}>
                            Delete
                        </button>
                    </div>
                </div>
