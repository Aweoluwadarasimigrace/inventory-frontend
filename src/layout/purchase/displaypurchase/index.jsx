...
import DeleteAndEditDropdown from '../deleteandeditdeopdown'
          ...
          >
            <div className="space-y-3">
              ...
              <div className='flex justify-between items-center'>
                ...
                <DeleteAndEditDropdown purchaseId={purchase._id} />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <p
                    className={`font-semibold ${purchase.paymentStatus === "Paid"
                        ? "text-green-600"
                        : "text-red-500"
                      }`}
                  >
