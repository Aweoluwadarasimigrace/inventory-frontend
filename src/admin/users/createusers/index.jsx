...
{/* 3.username */}
        ...
        <div className="pt-4">
          <button
            type="submit" className="w-full bg-purple-600 text-white py-3 rounded-md text-lg font-semibold">
            {isloading ? "loading" : "Create User"}
          </button>
        </div>
      </form>

      <button type='button' onClick={() => setdialog(false)} className="bg-gray-100 border px-4 py-2 rounded">
        close
      </button>
    </div>
  )
