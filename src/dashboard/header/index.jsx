...
const Header = ({user}) => { 
  ...
  return (
     ...
     <div className="relative">
        ...
        {/* Animated Dropdown */}
         <div
          className={`absolute right-0 mt-2 w-52 bg-white border rounded-lg shadow-md z-50 transition-all duration-200 ease-out transform ${
        ...
        >
          ...
          <div className="px-4 py-3 border-b">
            ...
            <p className="mt-1 text-sm text-gray-800 underline decoration-purple-500">
              {user.name}
            </p>
          </div>
